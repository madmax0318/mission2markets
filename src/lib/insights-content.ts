...
/** Default insights article — shown on /blog when DB is empty or as fallback */
export const defaultMissionInsight: BlogPost = {
  id: "default-mission-insight",
  title: "Why We Built Mission 2 Markets",
  slug: "why-we-built-mission-2-markets",
  excerpt:
  ...
  body: `## From Service to Sales. From Mission to Market.
...
Explore our programs and resources on the site, connect with us through a consultation, and return here for leadership insights from the field—not theory from the sidelines.
...
/** Newest insights at top, oldest at bottom */
export function sortInsightsPosts(posts: BlogPost[]): BlogPost[] {
